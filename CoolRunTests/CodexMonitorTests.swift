...
final class CodexMonitorTests: XCTestCase {
    ...
    func testSessionMetadataUsesIndexTitleAndDetectsDesktopSource() throws {
        let json = """
        {"type":"session_meta","payload":{"id":"session-123","cwd":"/Users/test/Projects/CoolRun","originator":"codex_desktop"}}
        ...
        XCTAssertEqual(unwrapped.projectName, "CoolRun")
    ...
    func testCodexMonitorRendersAtMenuBarSize() throws {
        ...
        let output = URL(fileURLWithPath: NSTemporaryDirectory())
            .appendingPathComponent("coolrun-codex-monitor-preview.png")
